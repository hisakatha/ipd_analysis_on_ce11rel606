...
#$ -V
#$ -j y
#$ -o ipd_summary_high_mapq_unique.log
#$ -cwd
#$ -N ipdSummary
#$ -pe smp 24
...
#INPUT=mapped.alignmentset.merged.sorted_by_name.hq_unique.sorted.minimum_header.bam
INPUT=mapped.alignmentset.merged.sorted_by_name.hq_unique.sorted.single_rg.bam
ipdSummary $INPUT --reference ../ce11rel606.xml --gff $fname.gff --bigwig $fname.bw --csv_h5 $fname.h5 --numWorkers 24 --pvalue 0.001 --verbose --maxLength 3000000000000 --methylFraction --identify m6A,m4C --mapQvThreshold 128
