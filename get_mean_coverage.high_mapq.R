...
forward_depth <- fread("mapped.alignmentset.merged.high_mapq.bam.forward_depth", header = FALSE, col.names = depth_cols)
reverse_depth <- fread("mapped.alignmentset.merged.high_mapq.bam.reverse_depth", header = FALSE, col.names = depth_cols)
