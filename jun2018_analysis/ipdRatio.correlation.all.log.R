...
# PCR data
#pcr_name <- "PCR";
#pcr_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce10rel606/1_pcr/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");
# WGA (whole genome amplification) data
#wga_name <- "WGA";
#wga_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce10rel606/3_whole_genome_pcr/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");
# WGF (whole genome fragments) data
#wgf_name <- "WGF";
#wgf_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce10rel606/2_whole_genome_fragments/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");

# Sample A
a_name <- "A_WGA_VC2010_OP50"
a_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_a_pcr_vc2010_op50/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");
# Sample B
b_name <- "B_WGA_VC2010_OP50"
b_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_b_pcr_vc2010_op50/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");
# Sample C
c_name <- "C_WGA_VC2010"
c_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_c_pcr_vc2010/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");
# Sample D
d_name <- "D_WGA_VC2010"
d_data <- h5file(name = "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_d_pcr_vc2010/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5", mode = "r");
# Sample K
...
### PCR vs. WGF
#thresh1 <- 25;
#result1 <- compare_between_two(pcr_data, pcr_name, wgf_data, wgf_name, pcr_targets_chr, pcr_targets_start, pcr_targets_end, thresh1, 0);

### PCR vs. WGA
#thresh2 <- 10;
#result2 <- compare_between_two(pcr_data, pcr_name, wga_data, wga_name, pcr_targets_chr, pcr_targets_start, pcr_targets_end, thresh2, 2);

### WGA vs. WGF
#thresh3 <- 25;
#result3 <- compare_between_two(wga_data, wga_name, wgf_data, wgf_name, whole_targets_chr, whole_targets_start, whole_targets_end, thresh3, length(pcr_targets_chr) - length(whole_targets_chr) + 4);

### a vs. b
result1 <- compare_between_two(a_data, a_name, b_data, b_name, whole_targets_chr, whole_targets_start, whole_targets_end, thresh, 0);

### c vs. d
result2 <- compare_between_two(c_data, c_name, d_data, d_name, whole_targets_chr, whole_targets_start, whole_targets_end, thresh, length(whole_targets_chr));

### k vs. l
result3 <- compare_between_two(k_data, k_name, l_data, l_name, whole_targets_chr, whole_targets_start, whole_targets_end, thresh, length(whole_targets_chr) * 2);

invisible(dev.off());

pdf(sprintf("ipdRatio.correlation.compact.all.cov%d.pdf", thresh), width = pdf_width, height = pdf_height, onefile = TRUE);
