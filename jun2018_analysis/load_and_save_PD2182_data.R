...
# PD2182
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/PD2182-20150119/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5"
PD2182_data <- parse_kinetics_h5(data_path, chrs)
cat("Loaded data PD2182\n")
...
PD2182_normBy_ab_data <- normalize_native_by_control(PD2182_data, ab_data)
cat("Generated PD2182_normBy_ab_data\n")
PD2182_normBy_cd_data <- normalize_native_by_control(PD2182_data, cd_data)
cat("Generated PD2182_normBy_cd_data\n")

save(PD2182_data, PD2182_normBy_ab_data, PD2182_normBy_cd_data, file = "load_and_save_PD2182_data.Rdata")

library(fst)

write_fst(PD2182_data, "load_and_save_PD2182_data.PD2182_data.fst", compress = 100)
write_fst(PD2182_normBy_ab_data, "load_and_save_PD2182_data.PD2182_normBy_ab_data.fst", compress = 100)
write_fst(PD2182_normBy_cd_data, "load_and_save_PD2182_data.PD2182_normBy_cd_data.fst", compress = 100)
