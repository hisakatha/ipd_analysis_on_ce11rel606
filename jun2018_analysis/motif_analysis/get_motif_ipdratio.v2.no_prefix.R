...
k_normBy_ab_occ <- fread(paste0("motif_occ.k_normBy_ab.bed.merged_occ"), sep = " ", col.names = merged_occ_col)
l_normBy_cd_occ <- fread(paste0("motif_occ.l_normBy_cd.bed.merged_occ"), sep = " ", col.names = merged_occ_col)
