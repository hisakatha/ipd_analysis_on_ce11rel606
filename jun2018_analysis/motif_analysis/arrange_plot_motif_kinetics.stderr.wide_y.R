...
plot_motif_kinetics <- function(kinetics, title_text, ylab_text, global_mean, global_var, global_size){
    if (kinetics[, .N] == 0) {
        g1 <- ggplot(NULL) + ggtitle(title_text) + geom_text(aes(x = 0, y = 0, label = "No Data"), size = 18) +
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.pdf", width = 16, height = 20)
plot_grid(plotlist = ab_plots, align = "none", ncol = 4)
plot_grid(plotlist = cd_plots, align = "none", ncol = 4)
plot_grid(plotlist = PD2182_plots, align = "none", ncol = 4)
plot_grid(plotlist = PD2182sequel_plots, align = "none", ncol = 4)
plot_grid(plotlist = k_normBy_ab_plots, align = "none", ncol = 4)
plot_grid(plotlist = l_normBy_cd_plots, align = "none", ncol = 4)
invisible(dev.off())
...
motifs2a <- c("tandem_repeat_s4_01down", "tandem_repeat_s4_01up", "tandem_repeat_s4_02down", "tandem_repeat_s4_03down", "tandem_repeat_s4_03up", "tandem_repeat_s4_04down", "tandem_repeat_s4_04up", "tandem_repeat_s4_05down", "tandem_repeat_s4_05up", "legend")
ylim_ipdratio2 <- c(-1, 1)

pdf("arrange_plot_motif_kinetics.stderr.wide_y.split.pdf", width = 16, height = 20)
plot_grid(plotlist = ab_plots[motifs1], align = "none", ncol = 4)
plot_grid(plotlist = cd_plots[motifs1], align = "none", ncol = 4)
plot_grid(plotlist = PD2182_plots[motifs1], align = "none", ncol = 4)
plot_grid(plotlist = PD2182sequel_plots[motifs1], align = "none", ncol = 4)
#plot_grid(plotlist = k_normBy_ab_plots[motifs1], align = "none", ncol = 4)
plot_grid(plotlist = lapply(k_normBy_ab_plots[motifs1], function(x){x + coord_cartesian(ylim = ylim_ipdratio2)}), align = "none", ncol = 4)
#plot_grid(plotlist = l_normBy_cd_plots[motifs1], align = "none", ncol = 4)
plot_grid(plotlist = lapply(l_normBy_cd_plots[motifs1], function(x){x + coord_cartesian(ylim = ylim_ipdratio2)}), align = "none", ncol = 4)
plot_grid(plotlist = ab_plots[motifs2], align = "none", ncol = 4)
plot_grid(plotlist = cd_plots[motifs2], align = "none", ncol = 4)
plot_grid(plotlist = PD2182_plots[motifs2], align = "none", ncol = 4)
plot_grid(plotlist = PD2182sequel_plots[motifs2], align = "none", ncol = 4)
plot_grid(plotlist = k_normBy_ab_plots[motifs2a], align = "none", ncol = 4)
plot_grid(plotlist = l_normBy_cd_plots[motifs2a], align = "none", ncol = 4)
invisible(dev.off())
