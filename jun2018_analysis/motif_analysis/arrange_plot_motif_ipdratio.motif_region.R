...
pdf_width <- 10
pdf_height <- 8
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.motif_region.ab.pdf", width = pdf_width, height = pdf_height)
...
invisible(dev.off())
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.motif_region.cd.pdf", width = pdf_width, height = pdf_height)
...
invisible(dev.off())
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.motif_region.PD2182.pdf", width = pdf_width, height = pdf_height)
...
invisible(dev.off())
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.motif_region.PD2182sequel.pdf", width = pdf_width, height = pdf_height)
