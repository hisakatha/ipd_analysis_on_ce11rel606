...
plot_motif_kinetics <- function(kinetics, estimate, title_text, ylab_text, global_mean, global_var, global_size){
    ...
    g1_outside20 <- g1 %+% kinetics_summary + geom_vline(xintercept = c(0.5, end_pos - 19.5), linetype = "dashed", size = 0.1) + scale_x_continuous(breaks = get_integer_breaks(kinetics_summary[, position]))
...
motifs_select1 <- c(motifs_select1, "null", motifs_select2, "null", "null", motifs_select1, motifs_select2)
...
for (motif_dir in motif_dirs) {
    ...
    type1_text <- "WGA"
    type2_text <- "native"
    ab_k_comparison_plots_tmp <- plot_motif_kinetics_comparison(ab_ipd, k_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, all_ab_deep_IPD_mean, all_ab_deep_IPD_var, all_ab_deep_IPD_size)
    ab_k_comparison_plots[[motif_dir]] <- ab_k_comparison_plots_tmp[["comparison"]] + theme(legend.position = "none")
    ab_k_comparison_plots_outside20[[motif_dir]] <- ab_k_comparison_plots_tmp[["comparison_outside20"]] + theme(legend.position = "none")
    ab_k_comparison_plots_outside10[[motif_dir]] <- ab_k_comparison_plots_tmp[["comparison_outside10"]] + theme(legend.position = "none")
    cd_l_comparison_plots_tmp <- plot_motif_kinetics_comparison(cd_ipd, l_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, all_cd_deep_IPD_mean, all_cd_deep_IPD_var, all_cd_deep_IPD_size)
    cd_l_comparison_plots[[motif_dir]] <- cd_l_comparison_plots_tmp[["comparison"]] + theme(legend.position = "none")
    cd_l_comparison_plots_outside20[[motif_dir]] <- cd_l_comparison_plots_tmp[["comparison_outside20"]] + theme(legend.position = "none")
    cd_l_comparison_plots_outside10[[motif_dir]] <- cd_l_comparison_plots_tmp[["comparison_outside10"]] + theme(legend.position = "none")
...
pdf_height_high <- (length(motifs_high_ipd) %/% ncol1 + 1) * height_per_motif
pdf_height_low <- (length(motifs_low_ipd) %/% ncol1 + 1) * height_per_motif
# Basic region
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
...
pdf_height_high <- (length(motifs_high_ipd) %/% ncol1 + 1) * height_per_motif
pdf_height_low <- (length(motifs_low_ipd) %/% ncol1 + 1) * height_per_motif
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

# outside10
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

# with estimate
ncol1 <- 3
pdf_height_high <- ((length(motifs_high_ipd) + 1) %/% ncol1 + 1) * height_per_motif
pdf_height_low <- ((length(motifs_low_ipd) + 1) %/% ncol1 + 1) * height_per_motif
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

# with estimate outside20
ncol1 <- 3
pdf_height_high <- ((length(motifs_high_ipd) + 1) %/% ncol1 + 1) * height_per_motif
pdf_height_low <- ((length(motifs_low_ipd) + 1) %/% ncol1 + 1) * height_per_motif
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

# with estimate outside10
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.ab.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.cd.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.PD2182sequel.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.k.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.l.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    ...
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
               ...
               list(p_text_PD2182sequel), PD2182sequel_plots[p_motifs], list(p_text_PD2182), PD2182_plots[p_motifs])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 1, rel_widths = c(0.1, rep(1, ncol2))))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low.pdf", width = pdf_width, height = pdf_height_low2)
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
               ...
               list(p_text_PD2182sequel), PD2182sequel_plots_outside20[p_motifs], list(p_text_PD2182), PD2182_plots_outside20[p_motifs])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 1, rel_widths = c(0.1, rep(1, ncol2))))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
               ...
               list(p_text_PD2182sequel), PD2182sequel_plots_outside10[p_motifs], list(p_text_PD2182), PD2182_plots_outside10[p_motifs])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 1, rel_widths = c(0.1, rep(1, ncol2))))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_k), k_plots_with_estimate[p_motifs], list(NULL), list(p_text_l), l_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_PD2182sequel), PD2182sequel_plots_with_estimate[p_motifs], list(NULL), list(p_text_PD2182), PD2182_plots_with_estimate[p_motifs], ab_plots_with_estimate["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = c(0.1, rep(1, ncol2), 0.5)))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_k), k_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_l), l_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_PD2182sequel), PD2182sequel_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_PD2182), PD2182_plots_with_estimate_outside20[p_motifs],
               ab_plots_with_estimate_outside20["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = c(0.1, rep(1, ncol2), 0.5)))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_k), k_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_l), l_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_PD2182sequel), PD2182sequel_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_PD2182), PD2182_plots_with_estimate_outside10[p_motifs],
               ab_plots_with_estimate_outside10["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = c(0.1, rep(1, ncol2), 0.5)))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.select1_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_select1)
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.extreme1_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_extreme1)
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.select1_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.extreme1_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.select1_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.extreme1_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
p_text_PD2182_ecoli <- ggdraw() + draw_label("PD2182 (PacBio RS II)\nE. coli", angle = 90)
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.high.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    # ab_plots["null"] returns NULL, because there is no such element
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
               ...
               list(p_text_PD2182sequel_ecoli), PD2182sequel_ecoli_plots[p_motifs], list(p_text_PD2182_ecoli), PD2182_ecoli_plots[p_motifs])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 1, rel_widths = rel_widths2))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.low.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.select1.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.extreme1.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
               ...
               list(p_text_PD2182sequel_ecoli), PD2182sequel_ecoli_plots_outside20[p_motifs], list(p_text_PD2182_ecoli), PD2182_ecoli_plots_outside20[p_motifs])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 1, rel_widths = rel_widths2))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.select1_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.extreme1_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
               ...
               list(p_text_PD2182sequel_ecoli), PD2182sequel_ecoli_plots_outside10[p_motifs], list(p_text_PD2182_ecoli), PD2182_ecoli_plots_outside10[p_motifs])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 1, rel_widths = rel_widths2))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.select1_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.extreme1_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
rel_widths2 <- c(0.15, rep(1, ncol2), 0.5)
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_k), k_plots_with_estimate[p_motifs], list(NULL), list(p_text_l), l_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_PD2182sequel), PD2182sequel_plots_with_estimate[p_motifs], list(NULL), list(p_text_PD2182), PD2182_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_ab_ecoli), ab_ecoli_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd_ecoli), cd_ecoli_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_k_ecoli), k_ecoli_plots_with_estimate[p_motifs], list(NULL), list(p_text_l_ecoli), l_ecoli_plots_with_estimate[p_motifs], list(NULL),
               list(p_text_PD2182sequel_ecoli), PD2182sequel_ecoli_plots_with_estimate[p_motifs], list(NULL), list(p_text_PD2182_ecoli), PD2182_ecoli_plots_with_estimate[p_motifs], ab_plots_with_estimate["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = rel_widths2))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.select1_with_estimate.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.extreme1_with_estimate.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_k), k_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_l), l_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_PD2182sequel), PD2182sequel_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_PD2182), PD2182_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_ab_ecoli), ab_ecoli_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd_ecoli), cd_ecoli_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_k_ecoli), k_ecoli_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_l_ecoli), l_ecoli_plots_with_estimate_outside20[p_motifs], list(NULL),
               list(p_text_PD2182sequel_ecoli), PD2182sequel_ecoli_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_PD2182_ecoli), PD2182_ecoli_plots_with_estimate_outside20[p_motifs], ab_plots_with_estimate_outside20["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = rel_widths2))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.select1_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.extreme1_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_k), k_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_l), l_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_PD2182sequel), PD2182sequel_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_PD2182), PD2182_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_ab_ecoli), ab_ecoli_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd_ecoli), cd_ecoli_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_k_ecoli), k_ecoli_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_l_ecoli), l_ecoli_plots_with_estimate_outside10[p_motifs], list(NULL),
               list(p_text_PD2182sequel_ecoli), PD2182sequel_ecoli_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_PD2182_ecoli), PD2182_ecoli_plots_with_estimate_outside10[p_motifs], ab_plots_with_estimate_outside10["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = rel_widths2))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.select1_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all_with_ecoli.extreme1_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
pdf_height_extreme1 <- n_sample * height_per_motif
pdf_width <- 13
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = c(0.1, rep(1, ncol2), 0.5)))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.select1_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.extreme1_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = c(0.1, rep(1, ncol2), 0.5)))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.select1_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.extreme1_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.high_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
    print(plot_grid(plotlist = plots, align = "none", ncol = ncol2 + 2, rel_widths = c(0.1, rep(1, ncol2), 0.5)))
}
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.low_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.select1_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5_linear.all.extreme1_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
