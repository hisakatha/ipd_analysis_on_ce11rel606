...
for (motif_dir in motif_dirs) {
    ...
    type2_text <- "E. coli"
    ab_comparison_plots_tmp <- plot_motif_kinetics_comparison(ab_ipd, ab_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010+OP50/WGA", ylab_expr, all_ab_deep_IPD_mean, all_ab_deep_IPD_var, all_ab_deep_IPD_size)
    ...
    cd_comparison_plots_tmp <- plot_motif_kinetics_comparison(cd_ipd, cd_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010/WGA", ylab_expr, all_cd_deep_IPD_mean, all_cd_deep_IPD_var, all_cd_deep_IPD_size)
    ...
    k_comparison_plots_tmp <- plot_motif_kinetics_comparison(k_ipd, k_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010+OP50/native", ylab_expr, all_k_deep_IPD_mean, all_k_deep_IPD_var, all_k_deep_IPD_size)
    ...
    l_comparison_plots_tmp <- plot_motif_kinetics_comparison(l_ipd, l_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010/native", ylab_expr, all_l_deep_IPD_mean, all_l_deep_IPD_var, all_l_deep_IPD_size)
    ...
    PD2182sequel_comparison_plots_tmp <- plot_motif_kinetics_comparison(PD2182sequel_ipd, PD2182sequel_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "PD2182/native", ylab_expr, all_PD2182sequel_deep_IPD_mean, all_PD2182sequel_deep_IPD_var, all_PD2182sequel_deep_IPD_size)
    ...
    type1_text <- "WGA"
    type2_text <- "native"
    ab_k_comparison_plots_tmp <- plot_motif_kinetics_comparison(ab_ipd, k_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010+OP50/C. elegans", ylab_expr, all_ab_deep_IPD_mean, all_ab_deep_IPD_var, all_ab_deep_IPD_size)
    ...
    cd_l_comparison_plots_tmp <- plot_motif_kinetics_comparison(cd_ipd, l_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010/C. elegans", ylab_expr, all_cd_deep_IPD_mean, all_cd_deep_IPD_var, all_cd_deep_IPD_size)
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high.pdf", width = pdf_width, height = pdf_height_high2)
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low.pdf", width = pdf_width, height = pdf_height_low2)
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside20[p_motifs], cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside10[p_motifs], cd_plots_outside10[p_motifs],
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate[p_motifs], cd_plots_with_estimate[p_motifs],
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside20[p_motifs], cd_plots_with_estimate_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside10[p_motifs], cd_plots_with_estimate_outside10[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots[p_motifs], cd_comparison_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.select1_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_select1)
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.extreme1_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_extreme1)
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots_outside20[p_motifs], cd_comparison_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.select1_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots_outside20[p_motifs], cd_comparison_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.extreme1_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots_outside20[p_motifs], cd_comparison_plots_outside20[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots_outside10[p_motifs], cd_comparison_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.select1_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots_outside10[p_motifs], cd_comparison_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.extreme1_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_comparison_plots_outside10[p_motifs], cd_comparison_plots_outside10[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.high.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    # ab_plots["null"] returns NULL, because there is no such element
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.low.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots[p_motifs], cd_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.select1.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots[p_motifs], cd_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.extreme1.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots[p_motifs], cd_plots[p_motifs],
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside20[p_motifs], cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside20[p_motifs], cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.select1_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside20[p_motifs], cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.extreme1_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside20[p_motifs], cd_plots_outside20[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside10[p_motifs], cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside10[p_motifs], cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.select1_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside10[p_motifs], cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.extreme1_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_outside10[p_motifs], cd_plots_outside10[p_motifs],
...
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
rel_widths2 <- rep(1, ncol2)
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate[p_motifs], cd_plots_with_estimate[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate[p_motifs], cd_plots_with_estimate[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.select1_with_estimate.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate[p_motifs], cd_plots_with_estimate[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.extreme1_with_estimate.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate[p_motifs], cd_plots_with_estimate[p_motifs],
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside20[p_motifs], cd_plots_with_estimate_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside20[p_motifs], cd_plots_with_estimate_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.select1_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside20[p_motifs], cd_plots_with_estimate_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.extreme1_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside20[p_motifs], cd_plots_with_estimate_outside20[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside10[p_motifs], cd_plots_with_estimate_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside10[p_motifs], cd_plots_with_estimate_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.select1_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside10[p_motifs], cd_plots_with_estimate_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all_with_ecoli.extreme1_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_plots_with_estimate_outside10[p_motifs], cd_plots_with_estimate_outside10[p_motifs],
...
pdf_height_extreme1 <- n_sample * height_per_motif
pdf_width <- 4
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots[p_motifs], cd_l_comparison_plots[p_motifs])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.select1_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots[p_motifs], cd_l_comparison_plots[p_motifs])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.extreme1_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots[p_motifs], cd_l_comparison_plots[p_motifs])
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots_outside20[p_motifs], cd_l_comparison_plots_outside20[p_motifs])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.select1_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots_outside20[p_motifs], cd_l_comparison_plots_outside20[p_motifs])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.extreme1_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots_outside20[p_motifs], cd_l_comparison_plots_outside20[p_motifs])
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.high_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.low_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots_outside10[p_motifs], cd_l_comparison_plots_outside10[p_motifs])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.select1_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots_outside10[p_motifs], cd_l_comparison_plots_outside10[p_motifs])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v7_linear_positive_strand_single_column.all.extreme1_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(ab_k_comparison_plots_outside10[p_motifs], cd_l_comparison_plots_outside10[p_motifs])
