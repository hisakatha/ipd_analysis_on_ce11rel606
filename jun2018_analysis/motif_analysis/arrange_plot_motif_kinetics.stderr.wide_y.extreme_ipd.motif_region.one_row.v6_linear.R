...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high.pdf", width = pdf_width, height = pdf_height_high2)
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low.pdf", width = pdf_width, height = pdf_height_low2)
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.select1_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_select1)
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.extreme1_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_extreme1)
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.select1_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.extreme1_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.select1_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.extreme1_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.high.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    # ab_plots["null"] returns NULL, because there is no such element
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.low.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.select1.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.extreme1.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.select1_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.extreme1_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.select1_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.extreme1_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.select1_with_estimate.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.extreme1_with_estimate.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.select1_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.extreme1_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.select1_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all_with_ecoli.extreme1_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
pdf_height_extreme1 <- n_sample * height_per_motif
pdf_width <- 13
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.select1_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.extreme1_wga_native_comparison.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots[p_motifs], ab_k_comparison_plots["legend"])
...
n_page_select1 <- ((n_motifs_select1 - 1) %/% ncol2) + 1
n_page_extreme1 <- ((n_motifs_extreme1 - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.select1_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.extreme1_wga_native_comparison_outside20.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside20[p_motifs], ab_k_comparison_plots_outside20["legend"])
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.high_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.low_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.select1_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_select1)
for(i in 1:n_page_select1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_select1, i * ncol2))
    p_motifs <- c(motifs_select1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v6_linear.all.extreme1_wga_native_comparison_outside10.pdf", width = pdf_width, height = pdf_height_extreme1)
for(i in 1:n_page_extreme1){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_extreme1, i * ncol2))
    p_motifs <- c(motifs_extreme1[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab_k), ab_k_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd_l), cd_l_comparison_plots_outside10[p_motifs], ab_k_comparison_plots_outside10["legend"])
