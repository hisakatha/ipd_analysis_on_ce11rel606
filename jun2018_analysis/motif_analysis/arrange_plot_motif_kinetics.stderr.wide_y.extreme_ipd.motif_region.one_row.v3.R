...
ncol1 <- 5
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.ab.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.cd.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.PD2182.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.PD2182sequel.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.ab.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.cd.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.PD2182.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v3.PD2182sequel.low.pdf", width = pdf_width, height = pdf_height_low)
