...
pdf_width <- 10
pdf_height <- 8
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.ab.pdf", width = pdf_width, height = pdf_height)
...
invisible(dev.off())
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.cd.pdf", width = pdf_width, height = pdf_height)
...
invisible(dev.off())
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.PD2182.pdf", width = pdf_width, height = pdf_height)
...
invisible(dev.off())
pdf("arrange_plot_motif_ipdratio.stderr.wide_y.PD2182sequel.pdf", width = pdf_width, height = pdf_height)
