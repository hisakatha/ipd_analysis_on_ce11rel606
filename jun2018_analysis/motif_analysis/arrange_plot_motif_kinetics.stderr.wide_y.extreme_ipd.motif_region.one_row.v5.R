...
plot_motif_kinetics <- function(kinetics, estimate, title_text, ylab_text, global_mean, global_var, global_size){
    ...
    ylim_lower <- ifelse(mean_min > -1.9, -2, mean_min - 0.2)
    ylim_upper <- ifelse(mean_max < 2.2, 2.3, ifelse(mean_max < 3.3, 3.4, mean_max + 0.2))
    ...
    g1 <- ggplot(plot_data, aes(position, mean)) + geom_point(alpha = 0.5) +
        ...
        theme(panel.grid = element_blank(), panel.border = element_rect(fill = NA, color = "gray"), panel.background = element_rect(fill = NA)) +
        ggtitle(title_text) + ylab(ylab_text) +
        geom_hline(yintercept = global_mean, linetype = "dashed", size = 0.2) +
    ...
    g1_outside20 <- g1 %+% kinetics_summary + geom_vline(xintercept = c(0.5, end_pos - 19.5), linetype = "dashed", size = 0.2) + scale_x_continuous(breaks = get_integer_breaks(kinetics_summary[, position]))
    ...
    g2 <- ggplot(plot_data, aes(ifelse(type == "observed", position - 0.15, position + 0.15), mean, color = type)) +
        ...
        geom_errorbar(aes(ymin = mean - sqrt(var / N), ymax = mean + sqrt(var / N)), alpha = 0.5) +
        facet_grid(strand ~ ., labeller = label_both) +
        theme(panel.grid = element_blank(), panel.border = element_rect(fill = NA, color = "gray"), panel.background = element_rect(fill = NA)) +
        ggtitle(title_text, subtitle = sprintf("r = %.3g (p = %.3g)", mean_cor, mean_cor_p)) + ylab(ylab_text) + xlab("position") +
        scale_x_continuous(breaks = get_integer_breaks(plot_data[, position])) + labs(color = "Data source") +
        coord_cartesian(ylim = c(ylim_lower, ylim_upper))
    g2_outside20 <- g2 %+% merged_summary + geom_vline(xintercept = c(0.5, end_pos - 19.5), linetype = "dashed", size = 0.2) + scale_x_continuous(breaks = get_integer_breaks(merged_summary[, position]))
...
plot_motif_kinetics_comparison <- function(kinetics1, kinetics2, type1, type2, title_text, ylab_text, global_mean, global_var, global_size){
    ...
    kinetics1_summary <- kinetics1[value > 0 & is.finite(value)][, .(position, strand, label, log2value = log2(value))][, .(mean = mean(log2value), var = var(log2value), .N, type = type1), by = .(position, strand, label)]
    ...
    kinetics2_summary <- kinetics2[value > 0 & is.finite(value)][, .(position, strand, label, log2value = log2(value))][, .(mean = mean(log2value), var = var(log2value), .N, type = type2), by = .(position, strand, label)]
...
for (motif_dir in motif_dirs) {
    ...
    k_plots_tmp <- plot_motif_kinetics(k_ipd, k_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, k_log2ipd_mean, k_log2ipd_var, k_log2ipd_size)
    ...
    l_plots_tmp <- plot_motif_kinetics(l_ipd, l_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, l_log2ipd_mean, l_log2ipd_var, l_log2ipd_size)
    ...
    ab_ecoli_plots_tmp <- plot_motif_kinetics(ab_ecoli_ipd, ab_ecoli_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, ab_log2ipd_mean, ab_log2ipd_var, ab_log2ipd_size)
    ...
    cd_ecoli_plots_tmp <- plot_motif_kinetics(cd_ecoli_ipd, cd_ecoli_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, cd_log2ipd_mean, cd_log2ipd_var, cd_log2ipd_size)
    ...
    k_ecoli_plots_tmp <- plot_motif_kinetics(k_ecoli_ipd, k_ecoli_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, k_log2ipd_mean, k_log2ipd_var, k_log2ipd_size)
    ...
    l_ecoli_plots_tmp <- plot_motif_kinetics(l_ecoli_ipd, l_ecoli_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, l_log2ipd_mean, l_log2ipd_var, l_log2ipd_size)
    ...
    PD2182_ecoli_plots_tmp <- plot_motif_kinetics(PD2182_ecoli_ipd, PD2182_ecoli_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, PD2182_log2ipd_mean, PD2182_log2ipd_var, PD2182_log2ipd_size)
    ...
    PD2182sequel_ecoli_plots_tmp <- plot_motif_kinetics(PD2182sequel_ecoli_ipd, PD2182sequel_ecoli_modelPrediction, lookup_motif_title(motif_dir), ylab_expr, PD2182sequel_log2ipd_mean, PD2182sequel_log2ipd_var, PD2182sequel_log2ipd_size)
    ...
    type2_text <- "E. coli"
    ab_comparison_plots_tmp <- plot_motif_kinetics_comparison(ab_ipd, ab_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, ab_log2ipd_mean, ab_log2ipd_var, ab_log2ipd_size)
    ...
    cd_comparison_plots_tmp <- plot_motif_kinetics_comparison(cd_ipd, cd_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, cd_log2ipd_mean, cd_log2ipd_var, cd_log2ipd_size)
    ...
    k_comparison_plots_tmp <- plot_motif_kinetics_comparison(k_ipd, k_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, k_log2ipd_mean, k_log2ipd_var, k_log2ipd_size)
    ...
    l_comparison_plots_tmp <- plot_motif_kinetics_comparison(l_ipd, l_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, l_log2ipd_mean, l_log2ipd_var, l_log2ipd_size)
    ...
    PD2182_comparison_plots_tmp <- plot_motif_kinetics_comparison(PD2182_ipd, PD2182_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, PD2182_log2ipd_mean, PD2182_log2ipd_var, PD2182_log2ipd_size)
    ...
    PD2182sequel_comparison_plots_tmp <- plot_motif_kinetics_comparison(PD2182sequel_ipd, PD2182sequel_ecoli_ipd, type1_text, type2_text, lookup_motif_title(motif_dir), ylab_expr, PD2182sequel_log2ipd_mean, PD2182sequel_log2ipd_var, PD2182sequel_log2ipd_size)
...
# Basic region
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.high.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.low.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.low.pdf", width = pdf_width, height = pdf_height_low)
...
pdf_height_high <- (length(motifs_high_ipd) %/% ncol1 + 1) * height_per_motif
pdf_height_low <- (length(motifs_low_ipd) %/% ncol1 + 1) * height_per_motif
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.high_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_outside20[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.low_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_outside20[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

# outside10
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.high_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_outside10[motifs_high_ipd], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_outside10[motifs_low_ipd], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.low_outside10.pdf", width = pdf_width, height = pdf_height_low)
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_with_estimate[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_with_estimate[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low)
...
pdf_height_high <- ((length(motifs_high_ipd) + 1) %/% ncol1 + 1) * height_per_motif
pdf_height_low <- ((length(motifs_low_ipd) + 1) %/% ncol1 + 1) * height_per_motif
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_with_estimate_outside20[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = l_plots_with_estimate_outside20[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

# with estimate outside10
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = ab_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = cd_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = k_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high)
plot_grid(plotlist = l_plots_with_estimate_outside10[c(motifs_high_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())

pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.ab.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = ab_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.cd.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = cd_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.PD2182sequel.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = PD2182sequel_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.k.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
plot_grid(plotlist = k_plots_with_estimate_outside10[c(motifs_low_ipd, "legend")], align = "none", ncol = ncol1)
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.l.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low)
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high.pdf", width = pdf_width, height = pdf_height_high2)
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low.pdf", width = pdf_width, height = pdf_height_low2)
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_ecoli_comparison.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots[p_motifs], list(NULL),
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_ecoli_comparison_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside20[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.high_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all.low_ecoli_comparison_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_comparison_plots_outside10[p_motifs], list(NULL), list(p_text_cd), cd_comparison_plots_outside10[p_motifs], list(NULL),
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.high.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    # ab_plots["null"] returns NULL, because there is no such element
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.low.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots[p_motifs], list(p_text_cd), cd_plots[p_motifs],
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.high_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.low_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside20[p_motifs], list(p_text_cd), cd_plots_outside20[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.high_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.low_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_outside10[p_motifs], list(p_text_cd), cd_plots_outside10[p_motifs],
...
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.high_with_estimate.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.low_with_estimate.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate[p_motifs], list(NULL),
...
n_page_high_ipd <- ((n_motifs_high_ipd - 1) %/% ncol2) + 1
n_page_low_ipd <- ((n_motifs_low_ipd - 1) %/% ncol2) + 1
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.high_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.low_with_estimate_outside20.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside20[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside20[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.high_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_high2)
for(i in 1:n_page_high_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_high_ipd, i * ncol2))
    p_motifs <- c(motifs_high_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
...
invisible(dev.off())
pdf("arrange_plot_motif_kinetics.stderr.wide_y.motif_region.one_row.v5.all_with_ecoli.low_with_estimate_outside10.pdf", width = pdf_width, height = pdf_height_low2)
for(i in 1:n_page_low_ipd){
    p_range <- (1 + (i - 1) * ncol2):(min(n_motifs_low_ipd, i * ncol2))
    p_motifs <- c(motifs_low_ipd[p_range], rep("null", ncol2 - length(p_range)))
    plots <- c(list(p_text_ab), ab_plots_with_estimate_outside10[p_motifs], list(NULL), list(p_text_cd), cd_plots_with_estimate_outside10[p_motifs], list(NULL),
