...
fwrite(ab_count_celegans[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.ab_celegans.all_bases.csv", thres))
fwrite(cd_count_celegans[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.cd_celegans.all_bases.csv", thres))
fwrite(k_count_celegans[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.k_celegans.all_bases.csv", thres))
fwrite(l_count_celegans[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.l_celegans.all_bases.csv", thres))
fwrite(PD2182_count_celegans[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.PD2182_celegans.all_bases.csv", thres))
fwrite(PD2182sequel_count_celegans[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.PD2182sequel_celegans.all_bases.csv", thres))
...
fwrite(ab_count_ecoli[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.ab_ecoli.all_bases.csv", thres))
fwrite(cd_count_ecoli[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.cd_ecoli.all_bases.csv", thres))
fwrite(k_count_ecoli[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.k_ecoli.all_bases.csv", thres))
fwrite(l_count_ecoli[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.l_ecoli.all_bases.csv", thres))
fwrite(PD2182_count_ecoli[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.PD2182_ecoli.all_bases.csv", thres))
fwrite(PD2182sequel_count_ecoli[, .(count = sum(count)), keyby = .(lower_exclusive, upper_inclusive)], file = sprintf("log2ipd_count_coverage%d.PD2182sequel_ecoli.all_bases.csv", thres))
