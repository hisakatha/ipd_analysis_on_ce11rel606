...
#TODO?: list all the tetramers
motifs <- c("AAAA", "AAAC", "AAAG", "AAAT", "AACA")
motif_titles <- list()
motif_strings <- list()
...
dimers_stats_ab <- fread("../../jun2018_ab_pcr_vc2010_op50/dimer_ipd_stats.csv")
dimers_stats_cd <- fread("../../jun2018_cd_pcr_vc2010/dimer_ipd_stats.csv")
dimers_stats_k <- fread("../../jun2018_k_nopcr_vc2010_op50/dimer_ipd_stats.csv")
dimers_stats_l <- fread("../../jun2018_l_nopcr_vc2010/dimer_ipd_stats.csv")
dimers_stats_PD2182sequel <- fread("../../PD2182-sequel/dimer_ipd_stats.csv")
...
for (motif_dir in motifs) {
    ...
    type2_text <- "E. coli"
    ab_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_ab_celegans, dimers_summary_ab_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010+OP50/WGA", ylab_expr, all_ab_deep_IPD_mean, all_ab_deep_IPD_var, all_ab_deep_IPD_size)
    ...
    cd_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_cd_celegans, dimers_summary_cd_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010/WGA", ylab_expr, all_cd_deep_IPD_mean, all_cd_deep_IPD_var, all_cd_deep_IPD_size)
    ...
    k_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_k_celegans, dimers_summary_k_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010+OP50/native", ylab_expr, all_k_deep_IPD_mean, all_k_deep_IPD_var, all_k_deep_IPD_size)
    ...
    l_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_l_celegans, dimers_summary_l_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010/native", ylab_expr, all_l_deep_IPD_mean, all_l_deep_IPD_var, all_l_deep_IPD_size)
    ...
    PD2182sequel_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_PD2182sequel_celegans, dimers_summary_PD2182sequel_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "PD2182/native", ylab_expr, all_PD2182sequel_deep_IPD_mean, all_PD2182sequel_deep_IPD_var, all_PD2182sequel_deep_IPD_size)
    ...
    type1_text <- "WGA"
    type2_text <- "native"
    ab_k_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_ab_celegans, dimers_summary_k_celegans, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010+OP50/C. elegans", ylab_expr, all_ab_deep_IPD_mean, all_ab_deep_IPD_var, all_ab_deep_IPD_size)
    ...
    cd_l_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_cd_celegans, dimers_summary_l_celegans, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "VC2010/C. elegans", ylab_expr, all_cd_deep_IPD_mean, all_cd_deep_IPD_var, all_cd_deep_IPD_size)
