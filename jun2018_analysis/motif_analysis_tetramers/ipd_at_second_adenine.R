...
stats_ab <- fread("../../jun2018_ab_pcr_vc2010_op50_no_chunk/tetramer_ipd_stats.csv")
stats_cd <- fread("../../jun2018_cd_pcr_vc2010_no_chunk/tetramer_ipd_stats.csv")
stats_k <- fread("../../jun2018_k_nopcr_vc2010_op50_no_chunk/tetramer_ipd_stats.csv")
stats_l <- fread("../../jun2018_l_nopcr_vc2010_no_chunk/tetramer_ipd_stats.csv")
stats_PD2182sequel <- fread("../../PD2182-sequel_no_chunk/tetramer_ipd_stats.csv")
stats_abcd <- fread("../../jun2018_abcd_pcr_no_chunk/tetramer_ipd_stats.csv")
stats_kl <- fread("../../jun2018_kl_nopcr_no_chunk/tetramer_ipd_stats.csv")
