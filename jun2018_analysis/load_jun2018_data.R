...
# AB
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_ab_pcr_vc2010_op50/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5"
ab_data <- parse_kinetics_h5(data_path, chrs)
cat("Loaded data AB\n")

# CD
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_cd_pcr_vc2010/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5"
cd_data <- parse_kinetics_h5(data_path, chrs)
cat("Loaded data CD\n")

# K
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_k_nopcr_vc2010_op50/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5"
k_data <- parse_kinetics_h5(data_path, chrs)
cat("Loaded data K\n")

# L
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_l_nopcr_vc2010/output/tasks/kinetics_tools.tasks.gather_kinetics_h5-1/file.h5"
