...
all_stats <- rbindlist(list(ab_stats, cd_stats, k_stats, l_stats, PD2182_stats, PD2182sequel_stats, k_normBy_ab_stats, l_normBy_cd_stats,
                            ab_stats2, cd_stats2, PD2182_stats2, PD2182sequel_stats2,
                            ab_stats3, cd_stats3, PD2182_stats3, PD2182sequel_stats3,
                            ab_stats4, cd_stats4, k_stats4, l_stats4, PD2182_stats4, PD2182sequel_stats4))
