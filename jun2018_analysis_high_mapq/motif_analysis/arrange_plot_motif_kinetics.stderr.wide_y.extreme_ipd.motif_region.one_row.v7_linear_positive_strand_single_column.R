...
motif_dirs <- unique(c(motifs_high_ipd, motifs_low_ipd, motifs_select1, motifs_select2, motifs_select3))
...
motifs_select1 <- c(motifs_select1, motifs_select2, motifs_select3)
