...
ab_ipd <- fread("motif_ipdratio.ab.csv")
cd_ipd <- fread("motif_ipdratio.cd.csv")
PD2182_ipd <- fread("motif_ipdratio.PD2182.csv")
PD2182sequel_ipd <- fread("motif_ipdratio.PD2182sequel.csv")
...
pdf("plot_ipdratio_correlation.pdf", onefile = TRUE, width = 6, height = 6)
