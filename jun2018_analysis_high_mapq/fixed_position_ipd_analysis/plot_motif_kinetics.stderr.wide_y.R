...
plot_motif_kinetics <- function(kinetics, title_text, ylab_text, global_mean, global_var, global_size){
    ...
    g1 <- ggplot(kinetics_summary, aes(position, mean, color = region)) + geom_point() + geom_errorbar(aes(ymin = mean - 2 * sqrt(var / N), ymax = mean + 2 * sqrt(var / N))) +
...
pdf("plot_motif_kinetics.stderr.wide_y.pdf", width = 16, height = 8)
plot_motif_kinetics(ab_ipd, paste0(motif, ": log2 IPD; the mean +/- 2 times the standard error of the mean; sample AB"), "log2 IPD (the mean +/- 2 times the standard error of the mean)", ab_log2ipd_mean, ab_log2ipd_var, ab_log2ipd_size)
plot_motif_kinetics(cd_ipd, paste0(motif, ": log2 IPD; the mean +/- 2 times the standard error of the mean; sample CD"), "log2 IPD (the mean +/- 2 times the standard error of the mean)", cd_log2ipd_mean, cd_log2ipd_var, cd_log2ipd_size)
plot_motif_kinetics(PD2182_ipd, paste0(motif, ": log2 IPD; the mean +/- 2 times the standard error of the mean; sample PD2182 (PacBio RS II)"), "log2 IPD (the mean +/- 2 times the standard error of the mean)", PD2182_log2ipd_mean, PD2182_log2ipd_var, PD2182_log2ipd_size)
plot_motif_kinetics(PD2182sequel_ipd, paste0(motif, ": log2 IPD; the mean +/- 2 times the standard error of the mean; sample PD2182sequel (PacBio Sequel)"), "log2 IPD (the mean +/- 2 times the standard error of the mean)", PD2182sequel_log2ipd_mean, PD2182sequel_log2ipd_var, PD2182sequel_log2ipd_size)
