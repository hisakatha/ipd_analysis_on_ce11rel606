...
k_normBy_ab_occ <- fread("motif_occ.deep_kinetics_region.k_normBy_ab.bed.slop20.bed.bed.merged_occ", sep = " ", col.names = merged_occ_col)
l_normBy_cd_occ <- fread("motif_occ.deep_kinetics_region.l_normBy_cd.bed.slop20.bed.bed.merged_occ", sep = " ", col.names = merged_occ_col)
