...
PD2182_ipd_ecoli <- fread("motif_ipd.PD2182.e_coli.csv")
PD2182sequel_ipd_ecoli <- fread("motif_ipd.PD2182sequel.e_coli.csv")
...
PD2182_mean_ecoli <- mean_log2value(PD2182_ipd_ecoli)[, .(position, strand, PD2182 = m)]
PD2182sequel_mean_ecoli <- mean_log2value(PD2182sequel_ipd_ecoli)[, .(position, strand, PD2182sequel = m)]
...
ipd_table <- Reduce(function(x, y) merge(x, y, all = TRUE, by = c("position", "strand")), list(ab_mean, cd_mean, k_mean, l_mean, PD2182sequel_mean, PD2182_mean, ab_mean_ecoli, cd_mean_ecoli, k_mean_ecoli, l_mean_ecoli, PD2182sequel_mean_ecoli, PD2182_mean_ecoli))
