...
ab_occ <- fread("motif_occ.deep_kinetics_region.ab.bed.merged.sorted.slop20.bed.bed.merged_occ", sep = " ", col.names = merged_occ_col)
cd_occ <- fread("motif_occ.deep_kinetics_region.cd.bed.merged.sorted.slop20.bed.bed.merged_occ", sep = " ", col.names = merged_occ_col)
