...
dimers_stats_ab <- fread("dimer_ipd_stats.ab.csv")
dimers_stats_cd <- fread("dimer_ipd_stats.cd.csv")
dimers_stats_k <- fread("dimer_ipd_stats.k.csv")
dimers_stats_l <- fread("dimer_ipd_stats.l.csv")
dimers_stats_PD2182sequel <- fread("dimer_ipd_stats.PD2182sequel.csv")
...
for (motif_dir in motifs) {
    ...
    ab_plots_tmp <- plot_motif_kinetics(dimers_summary_ab_celegans, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 1/WGA\n/C. elegans", ylab_expr, N_ab_deep_IPD_mean, N_ab_deep_IPD_var, N_ab_deep_IPD_size)
    ...
    cd_plots_tmp <- plot_motif_kinetics(dimers_summary_cd_celegans, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 2/WGA\n/C. elegans", ylab_expr, N_cd_deep_IPD_mean, N_cd_deep_IPD_var, N_cd_deep_IPD_size)
    ...
    k_plots_tmp <- plot_motif_kinetics(dimers_summary_k_celegans, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 1/native\n/C. elegans", ylab_expr, N_k_deep_IPD_mean, N_k_deep_IPD_var, N_k_deep_IPD_size)
    ...
    l_plots_tmp <- plot_motif_kinetics(dimers_summary_l_celegans, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 2/native\n/C. elegans", ylab_expr, N_l_deep_IPD_mean, N_l_deep_IPD_var, N_l_deep_IPD_size)
    ...
    ab_ecoli_plots_tmp <- plot_motif_kinetics(dimers_summary_ab_ecoli, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 1/WGA\n/E. coli", ylab_expr, N_ab_deep_IPD_mean, N_ab_deep_IPD_var, N_ab_deep_IPD_size)
    ...
    cd_ecoli_plots_tmp <- plot_motif_kinetics(dimers_summary_cd_ecoli, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 2/WGA\n/E. coli", ylab_expr, N_cd_deep_IPD_mean, N_cd_deep_IPD_var, N_cd_deep_IPD_size)
    ...
    k_ecoli_plots_tmp <- plot_motif_kinetics(dimers_summary_k_ecoli, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 1/native\n/E. coli", ylab_expr, N_k_deep_IPD_mean, N_k_deep_IPD_var, N_k_deep_IPD_size)
    ...
    l_ecoli_plots_tmp <- plot_motif_kinetics(dimers_summary_l_ecoli, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 2/native\n/E. coli", ylab_expr, N_l_deep_IPD_mean, N_l_deep_IPD_var, N_l_deep_IPD_size)
    ...
    type2_text <- "E. coli"
    ab_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_ab_celegans, dimers_summary_ab_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 1/WGA", ylab_expr, N_ab_deep_IPD_mean, N_ab_deep_IPD_var, N_ab_deep_IPD_size)
    ...
    cd_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_cd_celegans, dimers_summary_cd_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 2/WGA", ylab_expr, N_cd_deep_IPD_mean, N_cd_deep_IPD_var, N_cd_deep_IPD_size)
    ...
    k_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_k_celegans, dimers_summary_k_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 1/native", ylab_expr, N_k_deep_IPD_mean, N_k_deep_IPD_var, N_k_deep_IPD_size)
    ...
    l_comparison_plots_tmp <- plot_motif_kinetics_comparison(dimers_summary_l_celegans, dimers_summary_l_ecoli, type1_text, type2_text, lookup_motif_title(motif_dir), lookup_motif_string(motif_dir), "replicate 2/native", ylab_expr, N_l_deep_IPD_mean, N_l_deep_IPD_var, N_l_deep_IPD_size)
    ...
    type1_text <- "replicate 1/WGA/E. coli"
    type2_text <- "replicate 2/WGA/E. coli"
    ...
    type1_text <- "replicate 1/native/C. elegans"
    type2_text <- "replicate 2/native/C. elegans"
    ...
    type1_text <- "replicate 1/native/E. coli"
    type2_text <- "replicate 2/native/E. coli"
