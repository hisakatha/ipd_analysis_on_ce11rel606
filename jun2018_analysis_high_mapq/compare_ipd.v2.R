...
plot_control_ipd_vs_native_ipd(k_normBy_ab_data, "VC2010+OP50(WGA)", "VC2010+OP50(native)")
plot_control_ipd_vs_native_ipd(k_normBy_ab_data[refName != ecoli_chr], "VC2010+OP50(WGA) in C. elegans", "VC2010+OP50(native) in C. elegans")
plot_control_ipd_vs_native_ipd(k_normBy_ab_data[refName == ecoli_chr], "VC2010+OP50(WGA) in E. coli", "VC2010+OP50(native) in E. coli")
plot_control_ipd_vs_native_ipd(l_normBy_cd_data, "VC2010(WGA)", "VC2010(native)")
plot_control_ipd_vs_native_ipd(l_normBy_cd_data[refName != ecoli_chr], "VC2010(WGA) in C. elegans", "VC2010(native) in C. elegans")
plot_control_ipd_vs_native_ipd(l_normBy_cd_data[refName == ecoli_chr], "VC2010(WGA) in E. coli", "VC2010(native) in E. coli")
invisible(dev.off())
