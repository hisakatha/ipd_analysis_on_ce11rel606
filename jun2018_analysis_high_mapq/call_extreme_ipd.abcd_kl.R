...
abcd_data_orig <- copy(abcd_data)
kl_data_orig <- copy(kl_data)
...
kl_thres <- get_thres(kl_data)

save_intersection(abcd_data, abcd_data_orig, "abcd", abcd_thres, kl_data, kl_data_orig, "kl", kl_thres)
