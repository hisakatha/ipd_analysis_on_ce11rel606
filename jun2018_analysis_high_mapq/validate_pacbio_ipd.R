...
pdf(sprintf("validate_pacbio_ipd.coverage%g.pdf", coverage_thres), width = 12, height = 12)
plot_ipd_vs_pacbio_estimate(ab_data, "replicate 1 (WGA)")
plot_ipd_vs_pacbio_estimate(ab_data[refName != ecoli_chr], "replicate 1 (WGA) in C. elegans")
plot_ipd_vs_pacbio_estimate(ab_data[refName == ecoli_chr], "replicate 1 (WGA) in E. coli")
plot_ipd_vs_pacbio_estimate(cd_data, "replicate 2 (WGA)")
plot_ipd_vs_pacbio_estimate(cd_data[refName != ecoli_chr], "replicate 2 (WGA) in C. elegans")
plot_ipd_vs_pacbio_estimate(cd_data[refName == ecoli_chr], "replicate 2 (WGA) in E. coli")
plot_ipdratio_with_or_without_pacbio_estimate(k_normBy_ab_data, "replicate 1")
plot_ipdratio_with_or_without_pacbio_estimate(k_normBy_ab_data[refName != ecoli_chr], "replicate 1 in C. elegans")
plot_ipdratio_with_or_without_pacbio_estimate(k_normBy_ab_data[refName == ecoli_chr], "replicate 1 in E. coli")
plot_ipdratio_with_or_without_pacbio_estimate(l_normBy_cd_data, "replicate 2")
plot_ipdratio_with_or_without_pacbio_estimate(l_normBy_cd_data[refName != ecoli_chr], "replicate 2 in C. elegans")
plot_ipdratio_with_or_without_pacbio_estimate(l_normBy_cd_data[refName == ecoli_chr], "replicate 2 in E. coli")
invisible(dev.off())
