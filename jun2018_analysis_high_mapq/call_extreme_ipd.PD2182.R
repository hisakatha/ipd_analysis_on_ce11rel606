...
#PD2182_data_orig <- copy(PD2182_data)
#PD2182sequel_data_orig <- copy(PD2182sequel_data)
#k_data_orig <- copy(k_data)
#l_data_orig <- copy(l_data)

PD2182_data <- PD2182_data[tMean > 0]
PD2182sequel_data <- PD2182sequel_data[tMean > 0]
#abcd_data <- abcd_data[tMean > 0]
#k_data <- k_data[tMean >0]
#l_data <- l_data[tMean >0]
#kl_data <- kl_data[tMean > 0]

setkey(PD2182_data, tMean)
setkey(PD2182sequel_data, tMean)
#setkey(abcd_data, tMean)
#setkey(k_data, tMean)
#setkey(l_data, tMean)
#setkey(kl_data, tMean)

save_extreme_ipd(PD2182_data, "PD2182")
save_extreme_ipd(PD2182sequel_data, "PD2182sequel")
#save_extreme_ipd(abcd_data, "abcd")
#save_extreme_ipd(k_data, "k")
#save_extreme_ipd(l_data, "l")
#save_extreme_ipd(kl_data, "kl")
