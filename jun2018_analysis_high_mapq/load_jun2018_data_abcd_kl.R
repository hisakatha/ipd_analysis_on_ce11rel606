...
# ABCD
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_abcd_pcr_no_chunk/ipd_summary_high_mapq.h5"
abcd_data <- parse_kinetics_h5(data_path, chrs)
cat("Loaded data ABCD\n")

# KL
data_path <- "/glusterfs/hisakatha/methylation/smrtpipe/vs_ce11rel606/jun2018_kl_nopcr_no_chunk/ipd_summary_high_mapq.h5"
...
save(abcd_data, kl_data, kl_normBy_abcd_data, file = "load_jun2018_data_abcd_kl.RData")
