...
# Job scheduler
QSUB := /grid/sgeadmin/bin/lx24-amd64/qsub -q all.q -l mt=256G -sync y
...
ipd_summary_hq_h5 := ipd_summary_high_mapq.h5
ipd_summary_hq_gff := ipd_summary_high_mapq.gff
ipd_summary_hq_files := $(ipd_summary_hq_h5) $(ipd_summary_hq_gff)
$(ipd_summary_hq_files)&: $(INPUTS)
	$(QSUB) ../ipd_summary_high_mapq.sh
...
ipd_summary_gff_m6A_high_cov := $(ipd_summary_gff:.gff=.m6A_cov50.gff)
$(ipd_summary_gff_m6A_high_cov): $(ipd_summary_gff)
	cat $< | ../extract_m6A_cov50.sh > $@
ipd_summary_gff_m6A_high_cov25 := $(ipd_summary_gff:.gff=.m6A_cov25.gff)
$(ipd_summary_gff_m6A_high_cov25): $(ipd_summary_gff)
